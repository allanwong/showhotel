                                    ...
                                    items: [
                                        {
                                            ...
                                            label: "入住",
                                            flex: 2,
                                            value: { year: new Date().getFullYear(), day: new Date().getDate() + 1, month: new Date().getMonth() + 1 }
                                        },
                                        {
                                    ...
                                    items: [
                                        {
                                            ...
                                            label: "离开",
                                            flex: 2,
                                            value: { year: new Date().getFullYear(), day: new Date().getDate() + 2, month: new Date().getMonth() + 1 }
                                        },
                                        {
                                            xtype: 'timepickerfield',
                                            flex: 1,
